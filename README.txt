...
- Encryption and integrity support for pack and dynamic pack modes
    * ciphers: AES-128, Serpent-256 ThreeFish-1024 with integrity validation
...
A suite of regression tests is found in subdirectory BackupTest. The VS2005 project is set up to run the suite of tests. There is an option to run code coverage using OpenCover by uncommenting the "opencover backup" line in each file. (You must install and configure OpenCover first.)
